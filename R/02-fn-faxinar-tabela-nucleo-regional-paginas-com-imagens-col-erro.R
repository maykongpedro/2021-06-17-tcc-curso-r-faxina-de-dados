#' faxinar_tabela_ng_pag_com_img_col_erro
#'
#' Descrição da função
...
#' e imagens, cuja extração resultou em tabelas com 6 colunas e uma delas em branco.
#' 
...
#' 
faxinar_tabela_ng_pag_com_img_col_erro <- function(tabela_bruta_extraida, nome_nucleo_regional){
